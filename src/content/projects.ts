...
export const projects: Project[] = [
...

  {
    ...
    description:
      "فروشگاه پوشاک با مسیر خرید ۴ مرحله‌ای و سبد خرید drawer — تجربه‌ای روان از دیدن محصول تا پرداخت، با تمرکز روی کاهش سبدهای رهاشده.",
...

  {
    ...
    description:
      "برندبوک کامل یک استودیو — پالت رنگی تعاملی، سیستم تایپوگرافی، ۶ واریاسیون لوگو، و مجموعه‌ای از کاربردهای عملی در ۴ حوزه.",
